package com.example.bookdonation.Find_Donors;
...
public class Find_DonorsActivity extends AppCompatActivity {
    ...
    private FindDonerAdapter adapter;
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    Realist_LiteratureRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list12,Find_DonorsActivity.this,"Realist Literature");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Find_DonorsActivity.this,error.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    DystopianRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list11,Find_DonorsActivity.this,"Dystopian");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    FantasyRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list10,Find_DonorsActivity.this,"Fantasy");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    Speculative_FictionRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list9,Find_DonorsActivity.this,"Speculative Fiction");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    BildungsromanRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list8,Find_DonorsActivity.this,"Bildungsroman");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    WesternRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list7,Find_DonorsActivity.this,"Western");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    RomanceRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list6,Find_DonorsActivity.this,"Romance");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    HistoricalRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list5,Find_DonorsActivity.this,"Historical");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    HorrorRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list4,Find_DonorsActivity.this,"Horror");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    ThrillerRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list3,Find_DonorsActivity.this,"Thriller");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    MysteryRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list2,Find_DonorsActivity.this,"Mystery");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    Literary_FictionRecyclerView.setLayoutManager(new LinearLayoutManager(Find_DonorsActivity.this));
                    adapter = new FindDonerAdapter(list1,Find_DonorsActivity.this,"Literary Fiction");
