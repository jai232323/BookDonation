...
import com.example.bookdonation.Admin.Adapter.AdminDonateBookAdapter;
...
public class AdminDonateActivity extends AppCompatActivity {
    ...
    private List<BookDonationData> list1,list2,list3,list4,list5,list6,list7,list8,list9,list10,list11,list12;

    private AdminDonateBookAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Donated Books");
    ...
    private void Realist_Literature() {
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                        BookDonationData data = snapshot.getValue(BookDonationData.class);
                    ...
                    Realist_LiteratureRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list12,AdminDonateActivity.this,"Realist Literature");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminDonateActivity.this,error.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    DystopianRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list11,AdminDonateActivity.this,"Dystopian");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    FantasyRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list10,AdminDonateActivity.this,"Fantasy");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    Speculative_FictionRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list9,AdminDonateActivity.this,"Speculative Fiction");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    BildungsromanRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list8,AdminDonateActivity.this,"Bildungsroman");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    WesternRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list7,AdminDonateActivity.this,"Western");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    RomanceRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list6,AdminDonateActivity.this,"Romance");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    HistoricalRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list5,AdminDonateActivity.this,"Historical");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    HorrorRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list4,AdminDonateActivity.this,"Horror");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    ThrillerRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list3,AdminDonateActivity.this,"Thriller");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    MysteryRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list2,AdminDonateActivity.this,"Mystery");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    Literary_FictionRecyclerView.setLayoutManager(new LinearLayoutManager(AdminDonateActivity.this));
                    adapter = new AdminDonateBookAdapter(list1,AdminDonateActivity.this,"Literary Fiction");
